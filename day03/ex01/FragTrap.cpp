...
void	FragTrap::takeDamage(unsigned int amount)
{
	...
	if (this->_hp < 0)
		this->_hp = 0;
	std::cout << "FR4G-TP \x1b[35m" << this->_name << "\x1b[0m took \x1b[31m" << amount << "\x1b[0m of damage, armor blocked \x1b[32m" << this->_armor << 
...
void	FragTrap::beRepaired(unsigned int amount)
{
	...
	if (this->_hp > this->_mhp)
		this->_hp = this->_mhp;
	std::cout << "FR4G-TP \x1b[35m" << this->_name << "\x1b[0m recovers \x1b[32m" << healed 
